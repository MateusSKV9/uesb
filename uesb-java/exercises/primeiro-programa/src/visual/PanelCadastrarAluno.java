...
public class PanelCadastrarAluno extends JPanel {
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("Aluno da UESB");
			lblNewLabel.setBounds(355, 41, 132, 25);
	...
	private JPanel getPanel() {
		if (panel == null) {
			...
			panel.setBounds(10, 107, 390, 490);
	...
	private JTextField getTextField_3() {
		if (textField_3 == null) {
			...
			textField_3.setBounds(25, 74, 150, 25);
		}
		return textField_3;
	}
	...
	private JTextField getTextField_4() {
		if (textField == null) {
			...
			textField.setBounds(25, 127, 150, 25);
		}
		return textField;
	}
	...
	private JTextField getTextField_1_1() {
		if (textField_1 == null) {
			...
			textField_1.setBounds(25, 180, 150, 25);
		}
		return textField_1;
	}
	...
	private JTextField getTextField_2_1() {
		if (textField_2 == null) {
			...
			textField_2.setBounds(25, 233, 150, 25);
		}
		return textField_2;
	}
	...
	private JTextField getTextField_5() {
		if (textField_5 == null) {
			...
			textField_5.setBounds(25, 76, 177, 25);
	...
	private JLabel getLblNewLabel_2_1_5() {
		if (lblNewLabel_2_1_5 == null) {
			lblNewLabel_2_1_5 = new JLabel("Curso");
	...
	private JTextField getTextField_6() {
		if (textField_6 == null) {
			...
			textField_6.setBounds(25, 129, 177, 25);
	...
	private JTextField getTextField_8() {
		if (textField_8 == null) {
			...
			textField_8.setBounds(149, 339, 220, 25);
		}
		return textField_8;
	}
	...
	private JTextField getTextField_9() {
		if (textField_9 == null) {
			...
			textField_9.setBounds(25, 339, 114, 25);
		}
		return textField_9;
	}
	...
	private JPanel getPanel_1() {
		if (panel_1 == null) {
			...
			panel_1.setBounds(425, 107, 425, 254);
	...
	private JPanel getPanel_2() {
		if (panel_2 == null) {
			...
			panel_2.setBounds(425, 371, 425, 277);
			...
			panel_2.add(getTextField_11_1());
			panel_2.add(getLblNewLabel_2_1_7_2_1());
			panel_2.add(getTextField_12_1());
			panel_2.add(getLblNewLabel_2_1_7_3_1());
			panel_2.add(getSeparator_2_1());
			panel_2.add(getTextField_15());
			panel_2.add(getLblNewLabel_2_1_7_2_1_1());
		}
		return panel_2;
	}
	...
	private JTextField getTextField_10() {
		if (textField_10 == null) {
			...
			textField_10.setBounds(186, 129, 156, 25);
		}
		return textField_10;
	}
	...
	private JTextField getTextField_13() {
		if (textField_13 == null) {
			...
			textField_13.setBounds(20, 76, 383, 25);
		}
		return textField_13;
	}
	...
	private JTextField getTextField_14() {
		if (textField_14 == null) {
			...
			textField_14.setBounds(352, 129, 51, 25);
		}
		return textField_14;
	}
	...
	public JLabel getLblNewLabel_2_1_7_3_1() {
	...
	public JTextField getTextField_15() {
		if (textField_15 == null) {
			...
			textField_15.setBounds(20, 235, 383, 25);
		}
		return textField_15;
	}
	public JLabel getLblNewLabel_2_1_7_2_1_1() {
	...
	public JButton getBotaoCadastrar() {
		if (botaoCadastrar == null) {
			...
			botaoCadastrar.setBounds(747, 671, 103, 32);
		}
	...
	public JButton getBotaoLimpar() {
		if (botaoLimpar == null) {
			...
			botaoLimpar.setFont(new Font("Tahoma", Font.PLAIN, 15));
			botaoLimpar.setBounds(634, 671, 103, 32);
		}
		return botaoLimpar;
	}

	public static Object getbotaoCadastrar() {
